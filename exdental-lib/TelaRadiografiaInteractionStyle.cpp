...
using namespace geronimo_impl;
vtkStandardNewMacro(geronimo_impl::TelaRadiografiaInteractionStyle);
	
	void TelaRadiografiaInteractionStyle::OnMouseWheelForward()
	{
		vtkRenderWindowInteractor *rwi = this->Interactor;
		vtkCamera *camera = this->CurrentRenderer->GetActiveCamera();
		double viewportHeight = camera->GetParallelScale();
	...
	void TelaRadiografiaInteractionStyle::OnMouseWheelBackward()
	{
		vtkRenderWindowInteractor *rwi = this->Interactor;
		vtkCamera *camera = this->CurrentRenderer->GetActiveCamera();
		double viewportHeight = camera->GetParallelScale();
	...
	//----------------------------------------------------------------------------
	TelaRadiografiaInteractionStyle::TelaRadiografiaInteractionStyle()
	{
		...
		this->InteractionMode = MYIS_IMAGE2D;
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::StartWindowLevel()
	{
		if (this->State != VTKIS_NONE)
		{
			return;
		}
		this->StartState(MYIS_WINDOW_LEVEL);
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::EndWindowLevel()
	{
		if (this->State != MYIS_WINDOW_LEVEL)
		{
			return;
		}
		if (this->HandleObservers)
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::StartPick()
	{
		if (this->State != VTKIS_NONE)
		{
			return;
		}
		this->StartState(MYIS_PICK);
		if (this->HandleObservers)
		{
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::EndPick()
	{
		if (this->State != MYIS_PICK)
		{
			return;
		}
		if (this->HandleObservers)
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::StartSlice()
	{
		if (this->State != VTKIS_NONE)
		{
			return;
		}
		this->StartState(MYIS_SLICE);
	}

	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::EndSlice()
	{
		if (this->State != MYIS_SLICE)
		{
			return;
		}
		this->StopState();
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::OnMouseMove()
	{
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::OnLeftButtonDown()
	{
		int x = this->Interactor->GetEventPosition()[0];
		int y = this->Interactor->GetEventPosition()[1];
		...
		else if (this->InteractionMode == MYIS_IMAGE3D &&
		...
		else if (this->InteractionMode == MYIS_IMAGE_SLICING &&
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::OnLeftButtonUp()
	{
		switch (this->State)
		{
		case MYIS_WINDOW_LEVEL:
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::OnMiddleButtonDown()
	{
		...
		if ((this->InteractionMode == MYIS_IMAGE3D ||
			this->InteractionMode == MYIS_IMAGE_SLICING) &&
			this->Interactor->GetShiftKey())
		{
			this->StartSlice();
		}
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::OnMiddleButtonUp()
	{
		switch (this->State)
		{
		case MYIS_SLICE:
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::OnRightButtonDown()
	{
		int x = this->Interactor->GetEventPosition()[0];
		int y = this->Interactor->GetEventPosition()[1];
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::OnRightButtonUp()
	{
		switch (this->State)
		{
		case MYIS_PICK:
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::OnChar()
	{
		vtkRenderWindowInteractor *rwi = this->Interactor;
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::WindowLevel()
	{
		vtkRenderWindowInteractor *rwi = this->Interactor;
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::Pick()
	{
		this->InvokeEvent(vtkCommand::PickEvent, this);
	}

	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::Slice()
	{
		if (this->CurrentRenderer == NULL)
		{
			return;
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::SetImageOrientation(
	...
	void TelaRadiografiaInteractionStyle::SetCurrentImageToNthImage(int i)
	{
		if (!this->CurrentRenderer)
		{
			return;
	...
	//----------------------------------------------------------------------------
	void TelaRadiografiaInteractionStyle::PrintSelf(ostream& os, vtkIndent indent)
	{
		...
		if (this->InteractionMode == MYIS_IMAGE2D)
		{
			os << "Image2D\n";
		}
		else if (this->InteractionMode == MYIS_IMAGE3D)
